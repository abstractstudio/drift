...
EventManager.prototype.removeEventListener=function(a,b){this.eventListeners[a].pop(this.eventListeners[a].indexOf(b))};EventManager.prototype.fireEvent=function(a,b){var c;void 0!==(c=this.eventListeners[a])&&c.map(function(a){a(b)})};engine.Animation={};var Animation=function(){EventManager.call(this);this._interval=this._src=this.image=null;this._columns=this._rows=1;this.isPlaying=!0;this.isReverse=!1;this.loop=!0;this.frameIndex=this.frameCount=0;this.frameSpeed=40;this.startTime=0};$jscomp.inherits(Animation,EventManager);Animation.prototype.srcset=function(a){this._src=a;this.image=new Image;this.image.onload=this._onload.bind(this);this.image.onerror=this._onerror.bind(this);this.image.src=a};
...
Engine.prototype._render=function(){requestAnimationFrame(this._render.bind(this));var a=Date.now()-this.renderTime;this.renderTime=Date.now();this.render(this.context,this.canvas);this.renderHistory[this.renderTrackingIndex]=a;this.renderTrackingIndex++;this.renderTrackingIndex==this.renderTrackingCount&&(this.renderTrackingIndex=0)};Engine.prototype.setup=function(){};Engine.prototype.load=function(){};Engine.prototype.update=function(a){};Engine.prototype.render=function(a,b){};
Engine.prototype.stop=function(){};Engine.prototype.cleanup=function(){};Engine.prototype.main=function(){this._setup()};Engine.prototype.fps=function(){return this.renderHistory.map(function(a){return 1E3/a}).reduce(function(a,b){return a+b},0)/this.renderTrackingCount};engine.Sprite={};var Sprite=function(){this.x=2};window.Sprite=Sprite;var drift={Background:{}};drift.Sprite={};drift.Boat={};drift.Obstacle={};var Drift=function(a){Engine.call(this,a)};$jscomp.inherits(Drift,Engine);Drift.prototype.render=function(a,b){};window.onload=function(){var a=document.getElementById("canvas");game=new Drift(a);game.main()};drift.Mode={};
