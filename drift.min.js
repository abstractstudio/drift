...
EventManager.prototype.removeEventListener=function(a,b){this.eventListeners[a].pop(this.eventListeners[a].indexOf(b))};EventManager.prototype.fireEvent=function(a,b){var c;void 0!==(c=this.eventListeners[a])&&c.map(function(a){a(b)})};var asset={Animation:{}},Animation=function(){EventManager.call(this);this._interval=this._src=this.image=null;this._columns=this._rows=1;this.isPlaying=!0;this.isReverse=!1;this.loop=!0;this.frameIndex=this.frameCount=0;this.frameSpeed=40;this.startTime=0};$jscomp.inherits(Animation,EventManager);Animation.prototype.srcset=function(a){this._src=a;this.image=new Image;this.image.onload=this._onload.bind(this);this.image.onerror=this._onerror.bind(this);this.image.src=a};
